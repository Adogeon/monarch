<template>
<footer class=" text-center py-2"  style="background-color: rgba(0, 0, 0, 0.2);">
    <div class="flex justify-center">
      ...
      <div class="flex p-4 text-gray-700">
        <a href="https://www.facebook.com/profile.php?id=100086153693026" class="mr-3 w-6 h-6">
      ...
      <a href="https://www.instagram.com/monarch.builders/" class="w-6 h-6">
