        ...
        <div class="flex items-center mx-auto">
          <div class="grow-0 shrink-0 basis-auto w-full xl:w-8/12">
            <div class="px-6 py-12 md:px-12">
              <h2 class="text-3xl font-bold mb-6">Pre-contruction</h2>
              ...
              <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-x-6">
                <div class="mb-6">
                ...
                <div class="mb-6">
                  <p class="flex items-center">
                    ...
                    </svg>Creating execution roadmap
                  </p>
                </div>
                <div class="mb-6">
                  <p class="flex items-center">
                    ...
                    </svg>Sub-contracting and bidding
                  </p>
                </div>
      ...
      <div class="flex justify-center rounded-lg border shadow-lg bg-white">
        <div class="flex flex-wrap items-center">
          <div class="grow-0 shrink-0 basis-auto w-full lg:w-6/12 xl:w-8/12">
            <div class="px-6 py-12 md:px-12">
              <h2 class="text-3xl font-bold mb-6">Construction</h2>
              <p class="text-gray-500 mb-6">
                Nunc tincidunt vulputate elit. Mauris varius purus malesuada neque iaculis
                malesuada. Aenean gravida magna orci, non efficitur est porta id. Donec magna
                diam.
              ...
              <div class="grid md:grid-cols-3 lg:grid-cols-2 xl:grid-cols-3 gap-x-2">
                <div class="mb-6">
                  <p class="flex items-center">
                    <svg class="w-4 h-4 mr-2 text-gray-900" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                      <path fill="currentColor"
                ...
                <div class="mb-6">
                  <p class="flex items-center">
                    ...
                    </svg>Project Team Communication
                  </p>
                </div>
